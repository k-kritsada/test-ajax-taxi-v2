...
var URL_API = "https://203.151.165.162/v2/";
...
function CampaignEmailTest(email_id,campaign_id){
    ...
    if(AB_ENABLE){
        ...
        unitAsyncTestCurl('Campaign Email Update (-2)',
            {
                "session_id": SessionID,
                "method": 'PUT',
                "url": URL_API+'campaign'+'/'+campaign_id+'/'+'email'+'/'+(email_id-2),
                "subject": "This is subject",
                "from_name": "john",
                "from_email": "john@gmail.com",
                "reply_name": "sarah",
        ...
        unitAsyncTestCurl('Campaign Email Update (-1)',
            {
                "session_id": SessionID,
                "method": 'PUT',
    ...
    if(AB_ENABLE){
        ...
        if(AJAX_ERROR_REQUEST){
            QUnit.module("Campaign Error Test", function( hooks ) {
                ...
                unitAsyncTest('Campaign Email Duplicate [404]','campaign'+'/'+campaign_id+'/'+'email'+'/'+(email_id+10)+'/'+"duplicate",'POST',
                {
                    "session_id": SessionID
                },"404");
    ...
    if(AB_ENABLE){
        unitAsyncTestCurl('Campaign Update to send',
        {
            "session_id" : SessionID,
            "method": 'PUT',
            "url": URL_API+'campaign'+'/'+campaign_id,
            "campaign_name" : "Campaign Send "+now,
